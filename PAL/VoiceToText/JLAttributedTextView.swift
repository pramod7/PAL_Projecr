...
public class JLAttributedTextView: UITextView {
    ...
    public var fontName: String = "EduQLDBeginner-Regular" {
        didSet {
    ...
    public var MinfontSize: CGFloat = 20 {
        didSet {
            let font = UIFont(name: fontName, size: MinfontSize)
            textAttributes[NSAttributedString.Key.font] = font
            self.attributedText = NSAttributedString(string: self.text, attributes: textAttributes)
    ...
    public var MaxfontSize: CGFloat = 20 {
        didSet {
            let font = UIFont(name: fontName, size: MaxfontSize)
            textAttributes[NSAttributedString.Key.font] = font
            self.attributedText = NSAttributedString(string: self.text, attributes: textAttributes)
